...
<body>
        ...
        <tr>
            ...
            ">
                ...
                *******<br>
                ...
                DES ENSEIGNEMENTS SECONDAIRES<br>

                *******<br>

                ARRONDISSEMENT DE
                {{ $etablissement->sub_division }}<br>
            ...
            ">
                ...
                *******<br>
                ...
                {{ $etablissement->english_sub_division }}
                SUB DIVISION<br>
    ...
    <div class="title-container">
        ...
        <div class="title-box">
            ...
            <div class="en-title">
                CERTIFICATE OF RESUMPTION OF DUTY
            </div>
    ...
    <table style="margin-bottom: 2px;">
        ...
        <tr>
            ...
            <td class="label-en">
                ...
                Posted, Transferred, Appointed by
                Service Note, Decision or Order (1) N°:
    ...
    {{-- =========================================================
         PREMIÈRE PRISE DE SERVICE - ADMINISTRATION
    ========================================================== --}}
    <table>
    ...
    {{-- =========================================================
         PREMIÈRE PRISE DE SERVICE - ÉTABLISSEMENT
    ========================================================== --}}
    <table>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="width: 28%;" class="label-fr">
            ...
            "
                ...
                {{ isset($enseignant->interruption_start_date) && $enseignant->interruption_start_date
                    ? \Carbon\Carbon::parse($enseignant->interruption_start_date)->format('d/m/Y')
                    : '//' }}
            ...
            "
                ...
                {{ isset($enseignant->interruption_end_date) && $enseignant->interruption_end_date
                    ? \Carbon\Carbon::parse($enseignant->interruption_end_date)->format('d/m/Y')
                    : '//' }}
    ...
    <table>
        ...
        <tr>
            ...
            <td style="width: 7%;" class="label-fr">
                Motif :
            </td>
            ...
            "
                ...
                {{ $enseignant->interruption_reason ?? '//' }}
    ...
    <table>
        ...
        <tr>
            ...
            <td style="width: 56%;" class="label-fr">
                ...
                A effectivement repris son service
                le :
            ...
            "
                ...
                {{ isset($enseignant->service_resumption_date) && $enseignant->service_resumption_date
                    ? \Carbon\Carbon::parse($enseignant->service_resumption_date)->format('d/m/Y')
                    : '' }}
        ...
        <tr>
            ...
            <td class="label-en">
                ...
                Has effectively resumed duty on:
    ...
    <table style="margin-top: 10px;">
        ...
        <tr>
            ...
            ">
                ...
                <div style="margin-top: 12px;" class="label-fr">
