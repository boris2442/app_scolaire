    ...
    <div class="bg-secondary/10 border border-white/5 p-8 rounded-3xl mb-10">
        ...
        <form action="{{ route('admin.notes.store_bulk', $evaluation->id) }}" method="POST">
            ...
            <div class="mt-8 flex justify-end">
                <button type="submit"
                    class="bg-primary hover:bg-primary/80 text-secondary font-black px-8 py-3 rounded-xl uppercase text-xs shadow-lg shadow-primary/20">
