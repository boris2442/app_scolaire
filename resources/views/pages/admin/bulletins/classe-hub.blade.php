...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        <a href="{{ route('admin.bulletins.index', ['trimestre_id' => $trimestreId]) }}" class="inline-flex items-center text-sm text-foreground/60 hover:text-primary transition mb-4">
            <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7 7-7m8 14l-7-7 7-7"></path></svg>
            Retour aux classes
        </a>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-border pb-5">
            ...
            <a 
            {{-- href="{{ route('admin.bulletins.imprimer-classe', ['classe_id' => $classe->id, 'trimestre_id' => $trimestreId]) }}"  --}}
               target="_blank"
