        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if ($registre)
                {{-- <div class="flex justify-end mb-4">
                    <a href="{{ route('admin.registre-trimestriel', array_merge(request()->all(), ['action' => 'pdf'])) }}"
                        target="_blank"
                        class="inline-flex items-center space-x-2 px-4 py-2 bg-primary text-primary-foreground hover:bg-primary/90 text-sm font-medium rounded-lg transition shadow-sm">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H7a2 2 0 00-2 2v4h14z">
                            </path>
                        </svg>
