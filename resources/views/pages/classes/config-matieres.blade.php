...
<form action="{{ route('settings.classes.matieres.update', $classe) }}" method="POST">
            ...
            <tbody class="divide-y divide-border">
                ...
                <tr class="hover:bg-secondary/10 transition-colors">
                    ...
                    <td class="px-6 py-4">
                        ...
                        <span class="block text-[10px] text-muted-foreground uppercase font-black">{{ $m->code }}</span>
                    </td>
                    <td class="px-6 py-4">
    ...
    <div class="mt-6 flex justify-end">
        <button class="bg-primary text-white font-black px-8 py-3 rounded-xl uppercase text-xs tracking-widest shadow-lg shadow-primary/20">
