            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-card p-8 rounded-2xl border border-border shadow-sm">
                ...
                <div class="md:col-span-2 pt-4 flex justify-end gap-3">
                    <a href="{{ route('admin.enseignants.index') }}"
                        class="px-6 py-3 rounded-xl font-black  text-[10px] bg-secondary hover:bg-border transition-all">Annuler</a>
                    <button type="submit"
                        class="px-6 py-3 rounded-xl font-black  text-[10px] bg-primary text-white shadow-lg shadow-primary/20 hover:scale-105 transition-all">
