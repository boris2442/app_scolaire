...
<div class="p-4 md:p-6 space-y-4 bg-background min-h-screen text-foreground">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-card p-4 rounded-2xl border border-border shadow-sm">
        <div>
            <h1 class="text-lg font-black tracking-tight">Dashboard Enseignant</h1>
            <p class="text-[10px] text-foreground/50 uppercase tracking-widest font-bold">Session Active</p>
        </div>
        <div class="flex items-center gap-2">
            <button class="w-9 h-9 flex items-center justify-center bg-secondary text-secondary-foreground rounded-xl hover:ring-2 ring-primary/20 transition-all border border-border">
                <i class="fa-solid fa-bell text-xs"></i>
            </button>
            <a href="{{ route('profile.edit') }}" class="flex items-center gap-2 px-3 py-1.5 bg-secondary text-secondary-foreground rounded-xl border border-border hover:bg-secondary/80 transition-all">
    ...
    <div class="space-y-3">
        <h2 class="text-[10px] font-black uppercase tracking-widest text-foreground/30 px-1">Suivi des saisies par classe</h2>
                    ...
                    <div class="flex items-center gap-3 min-w-[200px]">
                        ...
                        <div>
                            <div class="flex items-center gap-1.5">
                                ...
                                <span class="text-[8px] px-1.5 py-0.5 rounded-md bg-secondary text-secondary-foreground border border-border font-bold uppercase">
                                    {{ $stat['niveau'] }}
                                </span>
                            </div>
                            <p class="text-[10px] text-foreground/60 font-medium uppercase">{{ $stat['matiere'] }}</p>
                        </div>
                    </div>
